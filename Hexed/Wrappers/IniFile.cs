...
namespace Hexed.Wrappers
{
    public class IniFile
    {
        ...
        public string GetString(string section, string name, string defaultValue = "", bool autoSave = false)
        {
            ...
            else if (autoSave) SetString(section, name, defaultValue);
        ...
        {
            if (int.TryParse(ReadValue(section, name), out int value)) return value;
            else if (autoSave) SetInt(section, name, defaultValue);
        ...
        {
            if (float.TryParse(ReadValue(section, name), out float value)) return value;
            else if (autoSave) SetFloat(section, name, defaultValue);
        ...
        public bool GetBool(string section, string name, bool defaultValue = false, bool autoSave = false)
        {
            ...
            if ("true".Equals(sVal) || "1".Equals(sVal) || "0".Equals(sVal) || "false".Equals(sVal)) return ("true".Equals(sVal) || "1".Equals(sVal));
